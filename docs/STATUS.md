...
| Global Power and Crossbar | ✅ Live | 1,172 clubs across 71 competitions on the shared scale (measured from the payloads 2026-08-02; the previous "892 across 50" was stale). Publicly named **Crossbar**; `global_elo` remains the payload field. Displayed on club pages, league tables, projection context, team pages, selectors, run-in difficulty and history charts, and ranked at `?league=power`. |
