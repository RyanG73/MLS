...
**Open specs — `docs/superpowers/specs/`; designed, owner has not approved, nothing built.** `2026-08-07-uefa-competition-forecasting-design.md` · `2026-08-07-leagues-cup-forecasting-design.md` · `2026-08-08-match-data-source-resilience-design.md`. **Retire:** deleted on ship like a plan, with 2–3 sentences into `PROJECT_HISTORY.md`.
