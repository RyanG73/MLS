...
- Edge-board 7-day slate: 42 matches across 6 leagues.
- Current risk flags: away_model_underdog=4, draw_heavy=10, home_model_underdog=1, low_total_draw_setup=4, no_line=23.
...
3. Historical Draw Calibration by Goal Total — Completed for played rows carrying `lam`/`mu`; surfaced by family in `model-slices.js`.
   - low total: draw 30.0% predicted vs 35.5% observed, played_n=245.
